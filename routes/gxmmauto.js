...
var auto_liquidation = require('../models/auto_liquidation');
...
var apimarketSupplyAndBorrowRateCalculation = async () => {
    let markets_data = [];
...
module.exports.route = function (router) {
    router.post('/supplyborrowcalc', apimarketSupplyAndBorrowRateCalculation);
    router.post('/pricecheck', priceCheck);
};